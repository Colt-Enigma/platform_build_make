...
""" % bcb_dev)
  ...
  if target_info.GetBuildProp("ro.colt.display.version") is not None:
    buildid = target_info.GetBuildProp("ro.colt.display.version")
    ...
    device = target_info.GetBuildProp("ro.colt.device")
